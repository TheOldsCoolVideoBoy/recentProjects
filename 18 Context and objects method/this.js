...
/*
То есть в обекте лежит функция, и она является свойством (типа то что помечается %название% : %значение%)
функция которая является свойством - это метод
 то есть любое свойство которое вычисляет значение есть метод
*/
